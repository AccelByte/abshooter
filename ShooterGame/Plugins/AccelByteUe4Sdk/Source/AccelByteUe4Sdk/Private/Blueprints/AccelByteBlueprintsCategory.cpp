...
{
	GetCategory(AccelByte::Settings::ServerBaseUrl, CredentialStore.GetUserAccessToken(), CredentialStore.GetUserNamespace(), ParentPath, Language, OnSuccess, OnError);
}
...
{
	 GetChildCategories(AccelByte::Settings::ServerBaseUrl, CredentialStore.GetUserAccessToken(), CredentialStore.GetUserNamespace(), Language, CategoryPath, OnSuccess, OnError);
}
...
{
	GetDescendantCategories(AccelByte::Settings::ServerBaseUrl, CredentialStore.GetUserAccessToken(), CredentialStore.GetUserNamespace(), Language, CategoryPath, OnSuccess, OnError);
}
