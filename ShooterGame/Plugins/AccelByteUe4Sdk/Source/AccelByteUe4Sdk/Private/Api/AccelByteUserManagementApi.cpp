...
void UserManagement::GetUserByLoginId(const FString& LoginId, const FGetUserByLoginIdSuccess OnSuccess, const FErrorHandler& OnError)
{
	...
	FRegistry::HttpRetryScheduler.ProcessRequest(Request, FHttpRequestCompleteDelegate::CreateStatic(GetUserByLoginIdResponse, OnSuccess, OnError), FPlatformTime::Seconds());
}
