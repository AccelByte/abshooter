...
#include "GalleryEditInterface.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UGalleryEditInterface : public UInterface
{
	GENERATED_BODY()
};

/**
 * Interface for the UMG gallery edit widget.
 */
class IGalleryEditInterface
{
	GENERATED_BODY()
