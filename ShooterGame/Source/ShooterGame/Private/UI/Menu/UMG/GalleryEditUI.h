...
#include "GalleryEditUI.generated.h"

/**
 * Gallery edit UI widget.
 */
UCLASS()
class UGalleryEditUI : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	*/
	void SetInterface(IGalleryEditInterface* Interface);
...
private:
	...
	IGalleryEditInterface* GalleryEditInterface;
